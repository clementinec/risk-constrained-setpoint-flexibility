...
def reviewer_evidence_map() -> pd.DataFrame:
    ...
    rows = [
        ...
        ("R1-3", "single selected zone and synchronous building actuation", "empirical_plus_limitation", "M4 full-grid learned mean-tail versus learned-p90 ablation", "M4 tests aggregation, not zone-level actuation; retain zonal actuation as an untested control configuration and limitation."),
        ...
        ("R3-3", "Denver design-day sizing and saturation", "diagnostic_scope_then_c2", "D01 accepted-output audit followed by the separately authorized 12-cell C2 city-design-condition sensitivity", "D01 alone did not authorize an improvised rerun; the later C2 package uses official companion DDYs and tests sizing sensitivity without claiming simultaneous component saturation."),
